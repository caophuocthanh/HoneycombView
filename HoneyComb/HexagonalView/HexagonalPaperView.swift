...
protocol HexagonalPaperViewDelegate: class {
...
class HexagonalPaperView: UIView, UIGestureRecognizerDelegate {
    
    weak var delegate: HexagonalPaperViewDelegate?
    
    var currentTouchHexagonalViews: [HexagonalView] = [] {
        didSet{
    ...
    var distanceTwoViewTouched: CGFloat? {
        didSet{
    ...
    typealias HexagonalViews = [HexagonalView]
    ...
    var hexagonalViews: HexagonalViews {
...
extension HexagonalPaperView {
    ...
    @discardableResult func drawHexagonalView(_ addressString: String, hub: Int) -> HexagonalView? {
        print("drawHexagonalView:", addressString, hub)
